    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-950 text-gray-100 p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          {/* Your logo instead of Lucide icon */}
        ...
        >
          ...
          <motion.div variants={inputVariants} className="relative group">
            <label
              htmlFor="emailId"
              className="absolute -top-3 left-4 text-xs font-medium text-gray-400 bg-gray-950 px-1 transition-all group-focus-within:text-blue-400"
            >
              Email
            </label>
            <input
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white font-semibold rounded-xl py-3 shadow-md transition-all duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-950 disabled:opacity-60"
          >
        ...
        <p className="text-center mt-6 text-sm text-gray-400">
          ...
          <NavLink to="/signup" className="font-medium text-blue-400 hover:underline">
            Sign Up
          </NavLink>
        </p>
      </motion.div>
